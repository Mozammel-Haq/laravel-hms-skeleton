                        ...
                        <tbody>
                            @forelse($medicines as $medicine)
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-{{ $medicine->status === 'active' ? 'success' : 'secondary' }}-subtle text-{{ $medicine->status === 'active' ? 'success' : 'secondary' }}">
                                    ...
                                    <td class="text-end">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('pharmacy.medicines.edit', $medicine) }}">
                                                        <i class="ti ti-pencil me-2"></i> Edit
                                                    </a>
                                                </li>
                                                <li>
                                                    <form action="{{ route('pharmacy.medicines.destroy', $medicine) }}" method="POST" onsubmit="return confirm('Are you sure?')">
                                                        @csrf
                                                        @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center py-4">
                                        ...
                                        <a href="{{ route('pharmacy.medicines.create') }}" class="btn btn-sm btn-primary mt-2">Add First Medicine</a>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
