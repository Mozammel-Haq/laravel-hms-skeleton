                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('appointments.update', $appointment) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="reason_for_visit" name="reason_for_visit" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="3">{{ old('reason_for_visit', $appointment->reason_for_visit) }}</textarea>
                            <x-input-error :messages="$errors->get('reason_for_visit')" class="mt-2" />
                        </div>

                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('appointments.index') }}" class="text-gray-600 hover:text-gray-900 mr-4">Cancel</a>
                            <x-primary-button>
