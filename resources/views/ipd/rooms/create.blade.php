    ...
    <div class="container-fluid mx-2 mt-2">
        <div class="card shadow-sm border-0">
            ...
            <div class="d-flex mb-2 justify-content-between align-items-center bg-primary-subtle text-primary px-4 pt-4 pb-3 rounded-top">
                <div>
                    <h4 class="fw-bold text-primary mb-2">Create Room</h4>
                ...
                <a href="{{ route('ipd.rooms.index') }}" class="btn btn-outline-primary btn-sm">
                ...
                <form method="post" action="{{ route('ipd.rooms.store') }}">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="room_number" class="form-control form-control-sm" required placeholder="e.g. 101">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label small text-muted">Type <span class="text-danger">*</span></label>
                            <input type="text" name="room_type" class="form-control form-control-sm" required placeholder="e.g. Private, Semi-Private">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label small text-muted">Daily Rate <span class="text-danger">*</span></label>
                            <div class="input-group input-group-sm">
                                <span class="input-group-text">৳</span>
                                <input type="number" step="0.01" name="daily_rate" class="form-control" required placeholder="0.00">
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="mt-4 pt-3 border-top d-flex gap-2 justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm px-4">Save Room</button>
                    </div>
                </form>
            </div>
        </div>
