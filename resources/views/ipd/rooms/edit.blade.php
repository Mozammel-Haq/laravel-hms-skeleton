    ...
    <div class="container-fluid mx-2 mt-2">
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body p-3">
                            <!-- Header -->
            <div class="d-flex mb-2 justify-content-between align-items-center bg-primary-subtle text-primary p-3 rounded-top">
                <div>
                    <h4 class="fw-bold text-primary mb-2">Edit Room</h4>
