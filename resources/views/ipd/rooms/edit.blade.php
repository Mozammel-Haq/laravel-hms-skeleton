            ...
            <form method="post" action="{{ route('ipd.rooms.update', $room) }}">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select name="ward_id" class="form-select" required>
                            @foreach($wards as $ward)
                                <option value="{{ $ward->id }}" @if($room->ward_id===$ward->id) selected @endif>{{ $ward->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" name="daily_rate" class="form-control" value="{{ $room->daily_rate }}" required>
                    </div>
                    <div class="col-md-6">
