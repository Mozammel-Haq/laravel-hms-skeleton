<x-app-layout>
    <div class="container-fluid mx-2 mt-2">
        <div
            class="d-flex justify-content-between align-items-center bg-primary-subtle text-primary px-4 py-2 rounded-top shadow-sm">
            <div>
                ...
                <div class="card-body p-3">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-sm">
                                <input type="number" name="tax" class="form-control form-control-sm" step="0.01"
                                    min="0" value="0">
                                <span class="input-group-text">%</span>
                            </div>
                        </div>
            ...
            <div class="card shadow-sm border-0 mb-4" x-data="window.bedMatrix(window.ipdBedsConfig)">
                <div class="card-body p-4">
                    ...
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div class="d-flex align-items-center gap-1">
                            <span class="badge bg-secondary-subtle text-secondary"><i class="ti ti-tools"></i></span>
