    ...
    <div class="container-fluid mx-2 mt-2">
        <div class="card shadow-sm border-0">
            ...
            <div class="d-flex mb-2 justify-content-between align-items-center bg-primary-subtle text-primary px-4 pt-4 pb-3 rounded-top">
                <div>
                    <h4 class="fw-bold text-primary mb-2">Create Bed</h4>
                ...
                <form method="post" action="{{ route('ipd.beds.store') }}">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="bed_number" class="form-control form-control-sm" required placeholder="e.g. B-101">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="mt-4 pt-3 border-top d-flex gap-2 justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm px-4">Save Bed</button>
                    </div>
                </form>
            </div>
        </div>
