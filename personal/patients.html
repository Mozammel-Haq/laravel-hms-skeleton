                                            ...
                                            <ul class="mb-3">
                                                <li class="mb-1">
                                                    <label
                                                        ...
                                                        <span class="avatar avatar-xs rounded-circle me-2"><img
                                                                src="{{ asset('assets') }}/img/users/user-33.jpg"
                                                ...
                                                <li class="mb-1">
                                                    <label
                                                        ...
                                                        <input class="form-check-input m-0 me-2" type="checkbox">
                                                        <span class="avatar avatar-xs rounded-circle me-2"><img
                                                                src="{{ asset('assets') }}/img/users/user-12.jpg"
                                                                class="flex-shrink-0 rounded-circle"
                                                ...
                                                <li class="mb-1">
                                                    <label
                                                        ...
                                                        <input class="form-check-input m-0 me-2" type="checkbox">
                                                        <span class="avatar avatar-xs rounded-circle me-2"><img
                                                                src="{{ asset('assets') }}/img/users/user-02.jpg"
                                                                class="flex-shrink-0 rounded-circle"
                                                ...
                                                <li>
                                                    <label
                                                        ...
                                                        <input class="form-check-input m-0 me-2" type="checkbox">
                                                        <span class="avatar avatar-xs rounded-circle me-2"><img
                                                                src="{{ asset('assets') }}/img/users/user-08.jpg"
                                                                class="flex-shrink-0 rounded-circle"
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <a href="patient-details.html" class="text-dark fw-semibold">Alberto Ripley <span
                                        class="text-body fs-13 fw-normal d-block"> 26, Male </span> </a>
                            </div>
                        </td>
                        <td>+1 41245 54132</td>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="fs-14 mb-1"><a href="doctor-details.html" class="fw-semibold">Dr. Mick
                                            Thompson</a></h6>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="patient-details.html" class="avatar avatar-md me-2">
                                    <img src="{{ asset('assets') }}/img/users/user-16.jpg" alt="product"
                                        class="rounded-circle">
                                </a>
                                <a href="patient-details.html" class="text-dark fw-semibold">Susan Babin <span
                                        class="text-body fs-13 fw-normal d-block"> 21, Female </span> </a>
                            </div>
                        </td>
                        <td>+1 54554 54789</td>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="fs-14 mb-1"><a href="doctor-details.html" class="fw-semibold">Dr.
                                            Sarah Johnson</a></h6>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <a href="patient-details.html" class="text-dark fw-semibold">Carol Lam <span
                                        class="text-body fs-13 fw-normal d-block"> 28, Female </span> </a>
                            </div>
                        </td>
                        <td>+1 43554 54985</td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="patient-details.html" class="avatar avatar-md me-2">
                                    <img src="{{ asset('assets') }}/img/users/user-25.jpg" alt="product"
                                        class="rounded-circle">
                                </a>
                                <a href="patient-details.html" class="text-dark fw-semibold">Marsha Noland <span
                                        class="text-body fs-13 fw-normal d-block"> 25, Female </span> </a>
                            </div>
                        </td>
                        <td>+1 47554 54257</td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="patient-details.html" class="avatar avatar-md me-2">
                                    <img src="{{ asset('assets') }}/img/users/user-39.jpg" alt="product"
                                        class="rounded-circle">
                                </a>
                                <a href="patient-details.html" class="text-dark fw-semibold">Irma Armstrong <span
                                        class="text-body fs-13 fw-normal d-block"> 32, Female </span> </a>
                            </div>
                        </td>
                        <td>+1 54114 57526</td>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="fs-14 mb-1"><a href="doctor-details.html" class="fw-semibold">Dr. Anna
                                            Kim</a></h6>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="patient-details.html" class="avatar avatar-md me-2">
                                    <img src="{{ asset('assets') }}/img/users/user-14.jpg" alt="product"
                                        class="rounded-circle">
                                </a>
                                <a href="patient-details.html" class="text-dark fw-semibold">Jesus Adams <span
                                        class="text-body fs-13 fw-normal d-block"> 27, Male </span> </a>
                            </div>
                        </td>
                        <td>+1 51247 56574</td>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="doctor-details.html" class="avatar me-2 flex-shrink-0">
                                    <img src="{{ asset('assets') }}/img/doctors/doctor-06.jpg" alt="img"
                                        class="rounded-circle">
                                </a>
                                <div>
                                    <h6 class="fs-14 mb-1"><a href="doctor-details.html" class="fw-semibold">Dr. John
                                            Smith</a></h6>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="patient-details.html" class="avatar avatar-md me-2">
                                    <img src="{{ asset('assets') }}/img/profiles/avatar-27.jpg" alt="product"
                                        class="rounded-circle">
                                </a>
                                <a href="patient-details.html" class="text-dark fw-semibold">Ezra Belcher <span
                                        class="text-body fs-13 fw-normal d-block"> 28, Male </span> </a>
                            </div>
                        </td>
                        <td>+1 41452 25741</td>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="doctor-details.html" class="avatar me-2 flex-shrink-0">
                                    <img src="{{ asset('assets') }}/img/doctors/doctor-07.jpg" alt="img"
                                        class="rounded-circle">
                                </a>
                                <div>
                                    <h6 class="fs-14 mb-1"><a href="doctor-details.html" class="fw-semibold">Dr. Lisa
                                            White</a></h6>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <a href="patient-details.html" class="text-dark fw-semibold">Glen Lentz <span
                                        class="text-body fs-13 fw-normal d-block"> 22, Male </span> </a>
                            </div>
                        </td>
                        <td>+1 51425 21498</td>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="doctor-details.html" class="avatar me-2 flex-shrink-0">
                                    <img src="{{ asset('assets') }}/img/doctors/doctor-08.jpg" alt="img"
                                        class="rounded-circle">
                                </a>
                                <div>
                                    <h6 class="fs-14 mb-1"><a href="doctor-details.html" class="fw-semibold">Dr.
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="patient-details.html" class="avatar avatar-md me-2">
                                    <img src="{{ asset('assets') }}/img/users/user-07.jpg" alt="product"
                                        class="rounded-circle">
                                </a>
                                <a href="patient-details.html" class="text-dark fw-semibold">Bernard Griffith <span
                                        class="text-body fs-13 fw-normal d-block"> 34, Male </span> </a>
                            </div>
                        </td>
                        <td>+1 45214 98741</td>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="doctor-details.html" class="avatar me-2 flex-shrink-0">
                                    <img src="{{ asset('assets') }}/img/doctors/doctor-09.jpg" alt="img"
                                        class="rounded-circle">
                                </a>
                                <div>
                                    <h6 class="fs-14 mb-1"><a href="doctor-details.html" class="fw-semibold">Dr.
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="patient-details.html" class="avatar avatar-md me-2">
                                    <img src="{{ asset('assets') }}/img/users/user-17.jpg" alt="product"
                                        class="rounded-circle">
                                </a>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="doctor-details.html" class="avatar me-2 flex-shrink-0">
                                    <img src="{{ asset('assets') }}/img/doctors/doctor-10.jpg" alt="img"
                                        class="rounded-circle">
                                </a>
                                <div>
                                    <h6 class="fs-14 mb-1"><a href="doctor-details.html" class="fw-semibold">Dr.
