...
//         var chart = new ApexCharts(
//             document.querySelector("#report_chart"),
//             options,
//         );
//         chart.render();
//     }
...
//         var chart = new ApexCharts(
//             document.querySelector("#report_chart_2"),
//             options,
//         );
//         chart.render();
//     }
...
//         var chart = new ApexCharts(
//             document.querySelector("#report_chart_3"),
//             options,
//         );
//         chart.render();
//     }
...
//         var chart = new ApexCharts(
//             document.querySelector("#report_chart_4"),
//             options,
//         );
//         chart.render();
//     }
...
//         var chart = new ApexCharts(
//             document.querySelector("#payment_report_chart"),
//             options,
//         );
//         chart.render();
//     }
...
//         var chart = new ApexCharts(
//             document.querySelector("#payment_report_chart_2"),
//             options,
//         );
//         chart.render();
//     }
...
//         var chart = new ApexCharts(
//             document.querySelector("#payment_report_chart_3"),
//             options,
//         );
//         chart.render();
//     }
...
//         var chart = new ApexCharts(
//             document.querySelector("#payment_report_chart_4"),
//             options,
//         );
//         chart.render();
//     }
...
//         var chart = new ApexCharts(
//             document.querySelector("#s-col-10"),
//             options,
//         );
//         chart.render();
//     }
...
//                     name: "Completed",
//                     data: [
//                         800, 1000, 1200, 1300, 1500, 700, 900, 1000, 1600, 1500,
//                         1200, 1100,
//                     ],
//                 },
//                 {
//                     name: "Ongoing",
//                     data: [
//                         700, 900, 1100, 1000, 1100, 600, 800, 950, 1300, 1200,
//                         1000, 950,
//                     ],
//                 },
//                 {
//                     name: "Rescheduled",
//                     data: [
//                         600, 700, 1100, 1100, 1900, 500, 700, 850, 1500, 1600,
//                         900, 850,
//                     ],
//                 },
//             ],
...
//                     type: "bar",
//                     data: [
//                         360, 280, 290, 270, 340, 220, 230, 180, 260, 200, 350,
//                         400,
//                     ],
//                 },
//                 {
...
//                     type: "area",
//                     data: [
//                         200, 195, 190, 185, 200, 160, 170, 165, 210, 215, 225,
//                         230,
//                     ],
//                 },
//             ],
...
//         var chart = new ApexCharts(
//             document.querySelector("#circle-chart-2"),
//             sCol,
//         );
//         chart.render();
//     }
...
//     var chart = new ApexCharts(
//         document.querySelector("#productive-chart"),
//         options,
//     );
//     chart.render();
// }
...
//     var chart = new ApexCharts(
//         document.querySelector("#unproductive-chart"),
//         options,
//     );
//     chart.render();
// }
...
//     var chart = new ApexCharts(document.querySelector("#utilization"), sCol);
...
//     var chart = new ApexCharts(document.querySelector("#car-chart"), sCol);
...
//     var chart = new ApexCharts(document.querySelector("#locationChart"), sCol1);
...
//     };
//     var chart = new ApexCharts(
//         document.querySelector("#summary_chart"),
//         options,
//     );
//     chart.render();
// }
...
//     var chart = new ApexCharts(
//         document.querySelector("#invoice_analytics"),
//         options,
//     );
//     chart.render();
// }
